...
<form <?php echo tag_attributes($formAttributes); ?>>
    ...
    <div id="search-narrow-by-fields" class="field form-group">
        ...
        foreach ($search as $i => $rows): ?>
            <div class="search-entry input-group mb-2">
                <?php
                //The POST looks like =>
                // advanced[0] =>
                //[field] = 'description'
                ...
                if ($newOmeka) {
                    echo $this->formSelect(
                        ...
                        array(
                            ...
                            'id' => null,
                            'class' => 'advanced-search-joiner inline mr-2'
                        ),
                        array(
                            'and' => __('AND'),
                            'or' => __('OR'),
                ...
                echo $this->formSelect(
                    ...
                    array(
                        ...
                        'id' => null,
                        'class' => 'advanced-search-element inline  mr-2',
                    ),
                ...
                echo $this->formSelect(
                    ...
                    array(
                        ...
                        'id' => null,
                        'class' => 'advanced-search-type inline  mr-2'
                    ),
                ...
                echo $this->formText(
                    ...
                    array(
                        ...
                        'id' => null,
                        'class' => 'advanced-search-terms inline  mr-2',
                    )
                );
                ?>
        ...
        <?php endforeach; ?>
        		...
        		<button type="button" class="add_search btn btn-success" title="<?php echo __('Add a Field'); ?>"><span class="glyphicon glyphicon-plus"></span> <?php echo __('Add a Field'); ?></button>
    </div>
