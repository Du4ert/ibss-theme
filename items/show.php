...
<div id="primary">
    <div class="row justify-content-center form-group">
        <div class="col-xs-12">
                <ul  class="nav">
                    <li class="next-item previous mr-2"><?php echo (link_to_previous_item_show()); ?></li>
					<li class=" next-item next ml-2"><?php echo (link_to_next_item_show()); ?></li>
                </ul>
        </div>
    </div>
    <div class="row page-header">
        <div class="col-xs-12">
            <h1><span class="glyphicon glyphicon-book"></span><b><?php  echo "ID: ".(metadata($item, 'id'))." " ?></b><?php echo $pageTitle; ?></h1>
        </div>
    </div>
        ...
        <div id="itemfiles" class="col-md-6">
            ...
            <div class="element-text"><?php echo custom_files_for_item(
                ...
                array(
                    ...
                    'imgAttributes' => array('class' => 'img-fluid'),
                ),
                // wrapper
